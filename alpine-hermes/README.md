...
该参数时生产默认值为 1024 MB。Alpine diskless 模式会把约 370 MB 系统文件
解压到 RAM，因此系统还会自动建立 512 MB zram swap，缓冲 NetSurf、GTK
和 hermes-agent 的内存峰值。部分浏览器无法稳定承受大于 1024 MB 的 v86 WebAssembly 内存。
